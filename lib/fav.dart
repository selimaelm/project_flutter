...
class Fav extends StatefulWidget {
  final dynamic games;
  const Fav({Key? key, required this.games}) : super(key: key);
  @override
...
class FavState extends State<Fav> {
  ...
  String _searchText = '';
   ...
   Future<void> _checkIfGameIsFavorite() async {
    final userDoc = await FirebaseFirestore.instance
        ...
        .get();
    setState(() {
      _gamesidds=userDoc.docs.first.data()['likes'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Mes jeux likés", style: TextStyle(   fontFamily: 'OpenSans',
            color: Colors.white)),
      ...
      body: wishedgames.isEmpty
        ...
        children: [
          Image.network(
            'https://cdn-eu.icons8.com/Es_Ocg3-i023aM6EFW-55A/74iRKWmU1kGm-ygNrdxkgg/Shape.png',
            width: 150,
            height: 150,
          ),
